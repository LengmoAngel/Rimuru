...
void leds_init(void)
{
    ...
    GPIO_WriteBit(BOARD_LED0_GPIO_PORT, gpio_init.Pins, 1u);
    GPIO_PinAFConf(BOARD_LED0_GPIO_PORT, gpio_init.Pins, GPIO_AF_15); /* disable the alternative functions. */

    gpio_init.Pins = BOARD_LED1_GPIO_PIN;
    gpio_init.PinMode = GPIO_PinMode_Out_PushPull;
    gpio_init.Speed = GPIO_Speed_50MHz;
    GPIO_Init(BOARD_LED1_GPIO_PORT, &gpio_init);
    GPIO_WriteBit(BOARD_LED1_GPIO_PORT, gpio_init.Pins, 1u);
    GPIO_PinAFConf(BOARD_LED1_GPIO_PORT, gpio_init.Pins, GPIO_AF_15); /* disable the alternative functions. */

    gpio_init.Pins = BOARD_LED2_GPIO_PIN;
    gpio_init.PinMode = GPIO_PinMode_Out_PushPull;
    gpio_init.Speed = GPIO_Speed_50MHz;
    GPIO_Init(BOARD_LED2_GPIO_PORT, &gpio_init);
    GPIO_WriteBit(BOARD_LED2_GPIO_PORT, gpio_init.Pins, 1u);
    GPIO_PinAFConf(BOARD_LED2_GPIO_PORT, gpio_init.Pins, GPIO_AF_15); /* disable the alternative functions. */

    gpio_init.Pins = BOARD_LED3_GPIO_PIN;
    gpio_init.PinMode = GPIO_PinMode_Out_PushPull;
    gpio_init.Speed = GPIO_Speed_50MHz;
    GPIO_Init(BOARD_LED3_GPIO_PORT, &gpio_init);
    GPIO_WriteBit(BOARD_LED3_GPIO_PORT, gpio_init.Pins, 1u);
    GPIO_PinAFConf(BOARD_LED3_GPIO_PORT, gpio_init.Pins, GPIO_AF_15); /* disable the alternative functions. */
